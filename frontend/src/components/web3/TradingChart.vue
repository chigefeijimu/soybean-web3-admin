...
import { getKLine, getPrice, getIndicators } from '@/service/api/web3'
...
<template>
  <div class="bg-slate-800/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-700/50">
    ...
    <div class="grid grid-cols-4 gap-4 pt-4 border-t border-slate-700">
      ...
      <div class="p-3 bg-slate-900/50 rounded-xl">
        <p class="text-xs text-slate-400 mb-1">MACD</p>
        <p :class="[
          'font-semibold',
