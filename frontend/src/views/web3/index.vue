...
import FeeTracker from '@/components/web3/FeeTracker.vue';
...
const tabs = [
  ...
  { id: 'social-graph', label: 'Social Graph', icon: '🕸️' },
  ...
  <div class="min-h-screen from-slate-900 via-purple-900 to-slate-900 bg-gradient-to-br p-4 text-white lg:p-6">
    ...
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
      ...
      <div class="lg:col-span-2 space-y-6">
        ...
        <div v-show="activeTab === 'arbitrage'">
          <ArbitrageScanner />
        </div>
        ...
        <!-- Wallet Snapshot Tab -->
        <div v-show="activeTab === 'wallet-snapshot'">
          <WalletSnapshot />
        </div>
        ...
        <!-- Social Graph Tab -->
        <div v-show="activeTab === 'social-graph'">
          <SocialGraph />
        </div>
