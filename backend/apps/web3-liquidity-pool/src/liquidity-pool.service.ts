...
export class LiquidityPoolService {
  private readonly UniswapV3Factory = '0x1F98431c8aD98523631AE4a59f267346ea31F984';
  private readonly AlchemyAPIKey = process.env.ALCHEMY_API_KEY || 'demo';
  ...
  getRecommendedFeeTier(token0Symbol: string, token1Symbol: string): number {
    // Stable pairs: 100, 500
    // Medium volatility: 3000
    // High volatility: 10000
