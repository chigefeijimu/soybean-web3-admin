...
export class TokenSentimentController {
   ...
   * GET /web3/token-sentiment/:symbol
   */
  @Get(':symbol')
   ...
   * GET /web3/token-sentiment/batch
   */
  @Get('batch/list')
  @HttpCode(HttpStatus.OK)
  ...
  /**
   * Get top bullish tokens
   * GET /web3/token-sentiment/top/bullish
   */
  @Get('top/bullish')
  @HttpCode(HttpStatus.OK)
   ...
   * GET /web3/token-sentiment/top/bearish
   */
  @Get('top/bearish')
  @HttpCode(HttpStatus.OK)
   ...
   * GET /web3/token-sentiment/overview
   */
  @Get('overview/market')
  @HttpCode(HttpStatus.OK)
   ...
   * GET /web3/token-sentiment/history/:symbol
   */
  @Get('history/:symbol')
  @HttpCode(HttpStatus.OK)
   ...
   * GET /web3/token-sentiment/tokens
   */
  @Get('tokens/list')
  @HttpCode(HttpStatus.OK)
